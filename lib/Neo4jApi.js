...
module.exports.connect = function (initUrl, username, password, callback)
{
	var _basePath;
	var _endpoints = {};
	...
	Request.prototype.send = function ()
	{
		var options = 
		{
			...
			headers: { Accept: 'application/json',
				Authorization: "Basic " + new Buffer(neo4j._username + ":" + neo4j._password).toString("base64")
				/*, 'X-Stream': 'true' */}
		};
